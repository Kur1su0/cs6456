...
/* lwg: modify to fit into TZ */
#define sod_img_load_color(zPath, len) sod_img_load_from_mem(zPath, len, SOD_IMG_COLOR)
#define sod_img_load_grayscale(zPath, len) sod_img_load_from_mem(zPath, len, SOD_IMG_GRAYSCALE)
